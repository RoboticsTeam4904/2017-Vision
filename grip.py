...
class GripVisionPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [8.474576271186441, 22.021276595744702]
        self.__hsv_threshold_saturation = [187.28813559322037, 255.0]
        self.__hsv_threshold_value = [120.05649717514123, 255.0]
