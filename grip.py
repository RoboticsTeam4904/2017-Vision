...
class GripPipeline:
    ...
    def __init__(self, pi=False):
        ...
        self.__hsv_threshold_hue = [45.762711864406775, 89.94771006130543]
        self.__hsv_threshold_saturation = [220.90395480225988, 255.0]
        self.__hsv_threshold_value = [207.8143417469414, 255.0]
    ...
    def calibrate(hsv_threshold_hue=[], hsv_threshold_saturation=[], hsv_threshold_value=[]):
